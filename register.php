...
<br><br><br>
<h2>Submit Details for Register</h2>
...
function add(){
	if(document.getElementById("password").value!=document.getElementById("b").value)
  	...
  	alert('Wellcome to Hospital Family');
    add2();
  }
}
</script>
...
<script>
   function add2(){ 
    ...
    window.location.href='adduser.php?name='+name+"&password="+password+"&email="+email;
   }</script>
</body>
