...
<script>if(temp==1){setTimeout(function(){window.location.href='s1.php'},3000);}</script>
<script>if(temp==2){setTimeout(function(){window.location.href='first.php'},3000);}</script>
</head>
