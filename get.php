...
$q="SELECT password from user where name='$name' and email='$email'";
...
<tr><td colspan='2'><br><h2 align="center"><?php echo"<a href='first.php' style='text-decoration:none;top:50%;left:50%; color:white;background-color:#FE2E64;spacing:10px;padding:10px;box-shadow:2px 2px 5px grey;text-shadow:2px 2px 5px black;box-radius:5px;'>LOGIN</a>";?></h2></td></tr>
</table>
